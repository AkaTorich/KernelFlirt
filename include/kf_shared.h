...
#define IOCTL_KF_SPOOF_SHARED_DATA  CTL_CODE(KF_DEVICE_TYPE, 0x853, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_KF_ALLOC_MEMORY      CTL_CODE(KF_DEVICE_TYPE, 0x806, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_KF_FREE_MEMORY       CTL_CODE(KF_DEVICE_TYPE, 0x807, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_KF_START_DRIVER       CTL_CODE(KF_DEVICE_TYPE, 0x905, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_KF_READ_FILE          CTL_CODE(KF_DEVICE_TYPE, 0x906, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_KF_WRITE_FILE         CTL_CODE(KF_DEVICE_TYPE, 0x907, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_KF_DELETE_PATH        CTL_CODE(KF_DEVICE_TYPE, 0x908, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_KF_CREATE_DIR         CTL_CODE(KF_DEVICE_TYPE, 0x909, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_KF_RENAME_PATH       CTL_CODE(KF_DEVICE_TYPE, 0x90A, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
typedef struct _KF_DIR_ENTRY {
    ...
    ULONG   Attributes;     /* FILE_ATTRIBUTE_xxx */
    ULONG64 FileSize;
    ULONG64 LastWriteTime;  /* FILETIME as uint64 */
